      ...
      <div class="row m-0">
        <div class="col-12 p-0">    
          <div class="login-card login-dark">
            <div>
              <div><a class="logo" href="{{ route('admin.login') }}"> <img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/ddpu-logo.jpg') }}" alt="" style="max-width: 17% !important;"><img class="img-fluid for-light" src="{{ asset('admin/assets/images/logo/ddpu-logo.jpg') }}" alt="looginpage" style="max-width: 41% !important;background: black;height: 57px;/* margin: 12px; */"></a></div>
